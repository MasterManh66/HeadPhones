...
<body>
    ...
    <!-- Modal Layout-->
    <div class="modal">
        <div class="modal__overlay js-form-exit">
                ...
                <div class="auth-form">
                    <div class="auth-form__container">
                        <div class="auth-form__header">
                            ...
                            <div class="auth-form__exit js-form-exit">
                            ...
                            <div class="auth-form__form">
                                <div class="auth-form__img">
                                    <img src="./assets/image/logo_login.png" alt="" class="auth-form__img">
                                </div>
                                <div class="auth-form__please">
                                    Vui lòng đăng nhập tài khoản Member để xem ưu đãi và thanh toán dễ dàng hơn.
                                </div>
                            </div>
