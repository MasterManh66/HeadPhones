                    ...
                    <div class="profile__view">
                        <div class="profile__view-wrap">
                            ...
                            <div class="profile__view-body">
                                <form class="form" action="bankProcess.php" method="post">
                                    <div class="profile__view-edit">
                                        <div class="profile__view-edit-change">
                                                ...
                                                <div class="profile__view-bank">
                                                    ...
                                                    if (isset($_SESSION['accId'])) {
                                                        ...
                                                        if (sqlsrv_has_rows($ktbank)) {
                                                            ...
                                                            echo "<span class='profile__view-bank-info'>" . $row['bankOwner'] . "</span>";
                                                            echo "<span class='profile__view-bank-info'>" . $row["bankName"] . "</span>";
                                                            echo "<span class='profile__view-bank-info'>" . $row["bankNumber"] . "</span>";
                                                            } else {
                                                                echo "Chưa có ngân hàng liên kết";
                                                            }
                                                        } else {
                                                            echo "Chưa có ngân hàng liên kết";
                                                        }
                                            ...
                                            <div class="profile__view-update">
                                                <input type="text" name="bankName" class="profile__update-person"
                                                    placeholder="Nhập tên ngân hàng mới">
                                            </div>
                                            <div class="profile__view-update">
                                                <input type="text" name="bankNumber" class="profile__update-person"
                                                    placeholder="Nhập số tài khoản mới">
                                            </div>
                                            <div class="profile__view-update">
                                                <input type="text" name="bankOwner" class="profile__update-person"
                                                    placeholder="Nhập tên chủ tài khoản mới">
                                            </div>
                                            <div class="profile__view-update">
                                                <input type="text" name="bankBranch" class="profile__update-person"
